                ...
                callback: function (progressModelView) {
                    ...
                    that.model.clear().save(that.serializeModel(), {
                        success: C1.ajaxSuccess(function (model, response) {
                            C1.loadTemplate('./cms/article/index.page.tpl.html', function (template) {
        ...
        onRemoveData: function (event) {
            ...
            C1.showConfirmModal({
                ...
                fn: function (confirm) {
                    ...
                    var url = C1.apiUrlRoot + '/v1/cms/article/d0001.json';
