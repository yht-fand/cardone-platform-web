define(['text!./index.tpl.html', './IndexModel'], function (indexTpl, IndexModel) {
    ...
    return Marionette.LayoutView.extend({
        id: "authority-navigation-index-" + _.now(),
                ...
                callback: function (progressModelView) {
                    ...
                    that.model.clear().save(that.serializeModel(), {
                        success: C1.ajaxSuccess(function (model, response) {
                            C1.loadTemplate('./authority/navigation/index.page.tpl.html', function (template) {
        ...
        onAddData: function (event) {
            ...
            C1.loadView({
                url: "./authority/navigation/addModal",
        ...
        onModifyData: function (event) {
            ...
            C1.loadView({
                url: "./authority/navigation/modifyModal",
                data: {
                    id: id
                },
        ...
        onRemoveData: function (event) {
            ...
            C1.showConfirmModal({
                ...
                fn: function (confirm) {
                    ...
                    var url = C1.apiUrlRoot + '/v1/authority/navigation/d0001.json';
