define(['text!./index.tpl.html', './IndexModel'], function (indexTpl, IndexModel) {
    ...
    return Marionette.LayoutView.extend({
        id: "authority-userGroupRole-index-" + _.now(),
                ...
                callback: function (progressModelView) {
                    ...
                    that.model.clear().save(that.serializeModel(), {
                        success: C1.ajaxSuccess(function (model, response) {
                            C1.loadTemplate('./authority/userGroupRole/index.page.tpl.html', function (template) {
        ...
        onAddData: function (event) {
            ...
            C1.loadView({
                url: "./authority/userGroupRole/addModal",
        ...
        onModifyData: function (event) {
            ...
            C1.loadView({
                url: "./authority/userGroupRole/modifyModal",
                data: {
                    id: id
                },
        ...
        onRemoveData: function (event) {
            ...
            C1.showConfirmModal({
                ...
                fn: function (confirm) {
                    ...
                    var url = C1.apiUrlRoot + '/v1/authority/userGroupRole/d0001.json';
