define(['text!./index.tpl.html', './IndexModel'], function (indexTpl, IndexModel) {
    ...
    return Marionette.LayoutView.extend({
        id: "usercenter-department-index-" + _.now(),
                ...
                callback: function (progressModelView) {
                    ...
                    that.model.clear().save(that.serializeModel(), {
                        success: C1.ajaxSuccess(function (model, response) {
                            C1.loadTemplate('./usercenter/department/index.page.tpl.html', function (template) {
        ...
        onAddData: function (event) {
            ...
            C1.loadView({
                url: "./usercenter/department/addModal",
        ...
        onModifyData: function (event) {
            ...
            C1.loadView({
                url: "./usercenter/department/modifyModal",
                data: {
                    id: id
                },
        ...
        onRemoveData: function (event) {
            ...
            C1.showConfirmModal({
                ...
                fn: function (confirm) {
                    ...
                    var url = C1.apiUrlRoot + '/v1/usercenter/department/d0001.json';
