define(['text!./index.tpl.html', './IndexModel'], function (indexTpl, IndexModel) {
    ...
    return Marionette.LayoutView.extend({
        id: "workflow-wfVariable-index-" + _.now(),
                ...
                callback: function (progressModelView) {
                    ...
                    that.model.clear().save(that.serializeModel(), {
                        success: C1.ajaxSuccess(function (model, response) {
                            C1.loadTemplate('./workflow/wfVariable/index.page.tpl.html', function (template) {
        ...
        onAddData: function (event) {
            ...
            C1.loadView({
                url: "./workflow/wfVariable/addModal",
        ...
        onModifyData: function (event) {
            ...
            C1.loadView({
                url: "./workflow/wfVariable/modifyModal",
                data: {
                    id: id
                },
        ...
        onRemoveData: function (event) {
            ...
            C1.showConfirmModal({
                ...
                fn: function (confirm) {
                    ...
                    var url = C1.apiUrlRoot + '/v1/workflow/wfVariable/d0001.json';
