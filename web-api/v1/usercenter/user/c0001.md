...
> **create,usercenter-create,usercenter-user-create,usercenter-user-c0001-create**

> **create-my-department,usercenter-create-my-department,usercenter-user-create-my-department,usercenter-user-c0001-create-my-department**

> **create-my,usercenter-create-my,usercenter-user-create-my,usercenter-user-c0001-create-my**

## 路径

[./web-api/v1/usercenter/user/c0001.json](./c0001.json)
